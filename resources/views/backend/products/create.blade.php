                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pricesale" name="sale_price" placeholder="Điền giá khuyến mại">
                                        @error('sale_price')    
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror()
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Giá bán</label>
                                        <input type="text" class="form-control" id="price" name="origin_price" placeholder="Điền giá gốc">
                                        @error('origin_price')    
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror()
                                    </div>
