					...
					<table class="table shopping-summery">
						...
						<tbody>
							...
							<tr>
								...
								<td class="price" data-title="Price"><span>{{$items->price}}</span></td>
								<td class="qty" data-title="Qty"><!-- Input Order -->
									<div class="input-group">
										<div class="button minus">
											<button type="button" class="btn btn-primary btn-number" disabled="disabled" data-type="minus" data-field="quant[{{$items->qty}}]">
												<i class="ti-minus"></i>
											</button>
										</div>
										<input type="text" name="quant[{{$items->qty}}]" class="input-number"  data-min="1" data-max="100" value="{{$items->qty}}">
										<div class="button plus">
											<button type="button" class="btn btn-primary btn-number" data-type="plus" data-field="quant[{{$items->qty}}]">
												<i class="ti-plus"></i>
											</button>
										</div>
									</div>
								...
								<td class="action" data-title="Remove"><a href="{{route('cart.remove', ['id' => $items->rowId])}}"><i class="ti-trash remove-icon"></i></a></td>
							</tr>
